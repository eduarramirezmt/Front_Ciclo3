function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://144.22.58.11:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosBike(id) {
    $.ajax({
        dataType: 'json',
        url:"http://144.22.58.11:8080/api/Bike/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://144.22.58.11:8080/api/Bike/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://144.22.58.11:8080/api/Bike/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://144.22.58.11:8080/api/Bike/update",
